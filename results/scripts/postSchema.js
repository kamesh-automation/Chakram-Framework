...
var request = require('../support/request/request.json');
...
describe("Dweet API", function() {
    ...
    before("Initialize a new dweet thing for the tests", function () {
        ...
        initialDweetData = request;
        namedDweetPost = chakram.post(endpoint[dweet] + "/for/" + specifiedThingName, initialDweetData);
    });
